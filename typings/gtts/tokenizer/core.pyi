...
class RegexBuilder:
    ...
    def __init__(self, pattern_args: Any, pattern_func: Any, flags: Any = ...) -> None: ...
...
class PreProcessorRegex:
    ...
    def __init__(self, search_args: Any, search_func: Any, repl: Any, flags: Any = ...) -> None: ...
...
class PreProcessorSub:
    ...
    def __init__(self, sub_pairs: Any, ignore_case: Any = ...) -> None: ...
    def run(self, textstr: str) -> str:
...
class Tokenizer:
    ...
    def __init__(self, regex_funcs: Any, flags: Any = ...) -> None: ...
    def run(self, text: str) -> list[str | Any]:
        """Tokenize `text`.
